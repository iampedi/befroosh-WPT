...
<main class="_page-featrues pb-14 md:pb-28 bg-gradient-to-b from-blue-50/50 to-white">
    <div class="container max-w-7xl mx-auto px-4 2xl:px-0">
        <div class="_page-wrapper">
            <div class="page-header-wrapper">
                ...
                <div class="header-bottom-mask"><a href="#PageContent"><i class="ph-light ph-mouse-simple"></i></a></div>
            </div>
