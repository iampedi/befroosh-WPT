                        ...
                        <?php if (function_exists('pll_current_language')) : ?>
                            ...
                            <?php else : ?>
                                <div class="_socials flex flex-col pb-12 gap-5 items-center">
                                    ...
                                    <div class="_items flex items-center justify-center gap-5 md:gap-6 w-full md:w-fit bg-gray-200/15 inset-shadow-sm inset-shadow-gray-200 rounded-4xl inset-ring inset-ring-gray-200/50 py-2.5 md:py-3 md:px-12 mx-auto">
                                        <div class="_item">
                                            <a href="https://www.facebook.com/befroosh.app" target="_blank" rel="noopener noreferrer" data-tip="Facebook" class="flex items-center text-gray-400 hover:text-fuchsia-700 duration-300 tooltip"><i class="ph ph-facebook-logo text-3xl"></i></a>
                                        </div>
                                    </div>
                                </div>
                            <?php endif; ?>
