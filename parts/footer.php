...
<footer>
    <div class="_footer pb-8 md:pb-18 pt-20 md:pt-28 bg-gradient-to-t from-gray-200 to-white">
        <div class="container max-w-7xl mx-auto px-6 md:px-0">
            <div class="_wrapper flex flex-col md:flex-row items-center gap-12">
                <div class="w-full md:w-2/5">
                    <div class="_footer-content flex flex-col items-start gap-4">
                        ...
                        <div class="_socials flex flex-col gap-3">
                            <h4 class="font-semibold">بفروش را دنبال کنید:</h4>
                            <div class="_items flex items-center gap-3 md:gap-6">
                                <div class="_item">
                ...
                <div class="w-full md:w-3/5">
                    <div class="_footer-tools grid grid-cols-2 md:grid-cols-3 gap-10 md:gap-12">
